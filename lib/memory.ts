...
export class MemoryManager {
   ...
   public async vectorSearch(
      ...
      const similarDocs = await vectorStore.similaritySearch(recentChatHistory, 3, { figureFileName }).catch(err => {
         console.log("🚀 ~ MemoryManager ~ similarDocs ~ err: Failed to get vector search results: ", err)
      })
